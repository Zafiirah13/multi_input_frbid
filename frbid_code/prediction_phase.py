...
def load_candidate(data_dir = './data/test_set/',n_images = 'dm_fq_time'):
    ...
    return dm_img, fq_img, ID

#---------------------------------------
#-------Prediction of a candidate-------
#---------------------------------------

def FRB_prediction(model_name, X_test_dm,X_test_freq, ID, result_dir, probability):
    '''
    ...
    overall_probability = fit_model.predict([X_test_dm, X_test_freq])
